...
/* Task declarations */
// from https://github.com/arkhipenko/TaskScheduler/wiki/API-Task#task note that we will use 
TsTask read_adc1_task(TASK_INTERVAL_PERIOD, TASK_FOREVER, &run_read_adc1_task, &task_scheduler, false, &init_read_adc1_task);// 1000us is 1kHz //NOLINT
TsTask read_adc2_task(TASK_INTERVAL_PERIOD, TASK_FOREVER, &run_read_adc2_task, &task_scheduler, false, &init_read_adc2_task); 
