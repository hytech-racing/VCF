...
PedalsSystemData_s PedalsSystem::evaluate_pedals(PedalSensorData_s pedals_data, unsigned long curr_millis)
{
    ...
    float _brake2_scaled_ = (fabs(static_cast<float>(brake_2 - std::min(_brakeParams.min_pedal_2,_brakeParams.max_pedal_2)))/fabs(static_cast<float>(_brakeParams.max_pedal_2 - _brakeParams.min_pedal_2)));
