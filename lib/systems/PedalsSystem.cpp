...
void PedalsSystem::tick(unsigned long curr_millis, VCFInterfaceData_s &interface_data, bool use_both_brake_sensors)
{
    ...
    {
        _data = evaluate_pedals(interface_data.pedal_sensor_data.accel_1,
                                interface_data.pedal_sensor_data.accel_2,
                                interface_data.pedal_sensor_data.brake_1,
                                interface_data.pedal_sensor_data.brake_2,
                                curr_millis);
    }
    else
    {
