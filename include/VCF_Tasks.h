...
/**
 * The read_gpio task will read the GPIO pins and store the results in a struct
 * defined in shared_firmware_types. This function relies on the GPIO pins being
 * defined in VCFConstants.h.
 */
